...
| [`wp-09-plan.md`](wp-09-plan.md) | WP-08C-acceptance-gated, sequential WP-09A–F contracts for one-case composition, isolated public oracle/metrics, the five bounded experiments, conservative selection, and one frozen global policy. | Unblocked: WP-08C accepted (2026-09-13). Start with WP-09A after its self-preflight. |
